...
$TXT_ROLES = "Sélectionnez un rôle :";
$TXT_USER = "Utilisateur normal";
$TXT_MANAGER = "Chef de projet";
$TXT_ADMIN  = "Administrateur";

$TXT_ERROR0 = "Le compte ".$usr." a bien été créé.";
$TXT_ERROR1 = "Erreur, le compte ".$usr." existe déjà.";
